...
from random_parser.base.random_parser import RandomParserFactory
...
class RandomGenerator:
    ...
    def registerOp2Factory(self):
        ...
        for register_op_name in self.args_.op_name:
            register_op_dir = Path(random_dir + '/nonmlu_ops/' +
                                   register_op_name)
    ...
    def run(self):
        ...
        for op_name in self.args_.op_name:
            ...
            op_file_dict = {}.fromkeys(utils.getJsonFileFromDir(op_json_path),
                                       op_name)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Random Case Generator',

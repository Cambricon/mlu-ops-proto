    ...
    def generateRandomInputs(self):
        for single_input in self.config_list['inputs']:
            ...
            if 'repeat' in single_input:
                input_key_num -= 1
                repeat_num = random.randint(single_input['repeat'][0],
                                            single_input['repeat'][1])
                same_input = []
        ...
        for i in range(len(random_cases)):
            ...
            if 'outputs' in self.config_list:
                ...
                for output_index in range(len(self.config_list['outputs'])):
                    output_temp = random_cases[i][cur_index:cur_index + self.
                                                  output_key_num[output_index]]
                    output_dict = {}
            ...
            if 'op_params' in self.config_list:
                ...
                for item in random_cases[i][cur_index:cur_index +
                                            self.op_param_num]:
